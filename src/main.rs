...
fn duck_move<const DIRECTION: Direction>(time: Res<Time>, mut sprite_positions: Query<&mut Transform, With<Duck>>) {
    sprite_positions.iter_mut().for_each(|mut transform| {
        match DIRECTION {
